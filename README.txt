Word Guessing Game:
  ...
  Functionality:
    ...
    the program will place that letter in its correct position. There is an option to 
    guess a word, which the player can type 'no' if they don't want to guess. If the player guesses incorrectly
